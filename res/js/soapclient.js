...
SOAPClient._sendSoapRequest = function(url, method, parameters, async, callback, wsdl)
{
    ...
    // send request
    var xmlHttp = SOAPClient._getXmlHttp();
    //发送请求前将将 XMLHttpRequest 对象的 responseType 成员设置为“msxml-document”，responseType 来请求 IE10/11（10以下兼容） 返回XMLHttpRequest MSXML 文档
    ...
    if (SOAPClient.userName && SOAPClient.password){
        ...
        //将 XMLHttpRequest 对象的 responseType 成员设置为“msxml-document”，responseType 来请求 IE10/11 （10以下兼容） 返回XMLHttpRequest MSXML 文档
        try { xmlHttp.responseType = 'msxml-document'; } catch(e){}
    }
...
if (!isIe)
{
    ...
    XMLDocument.prototype.selectNodes = Element.prototype.selectNodes = function (xpath)
    {
        ...
        //IE不支持evaluate方法，firefox和opera均支持
